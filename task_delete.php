...
$sql_compiled_to_delete_req = ' SELECT * FROM fzco_compiled INNER JOIN fzco_application ON fzco_compiled.compiled_application_id = fzco_application.application_id WHERE  DATEDIFF(NOW(),compiled_date) >= 0 AND compiled_status != "deleted"';
